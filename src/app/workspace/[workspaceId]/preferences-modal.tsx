                    ...
                    <div className="px-4 pb-4 flex flex-col gap-y-2">
                        <Dialog open={editOpen} onOpenChange={setEditOpen}>
                            <DialogTrigger asChild>
                                <div className="p-5 py-4 bg-white rounded-lg border cursor-pointer hover:bg-gray-50">
                            ...
                            <DialogContent>
                                ...
                                <form onSubmit={handleEdit} className="space-y-4">
                                    ...
                                    <DialogFooter>
                                        <DialogClose asChild>
                                            <Button variant="outline" disabled={updateWorkspaceIsPending}>
                                                Cancel
                                            </Button>
                                        </DialogClose>
                                        <Button disabled={updateWorkspaceIsPending}>
                                            Save
                                        </Button>
                                    </DialogFooter>
                                </form>
